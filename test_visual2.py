...
with DeepExplain(session = K.get_session()) as de:
    ...
    attributions_JG = de.explain('deeplift', target_tensor * Y_test, input_tensor, X_test)
...
# plot the explain
#print(attributions)
print(attributions_JG.shape)
plt.imshow(attributions_JG[0, :, :].squeeze(),aspect='auto')
plt.colorbar()
x=[0,250,500,750]
...
X_test       = X[2]     #0 -- 2; 2-- 3 134 132; 6 -- 4
Y_test       = y[2]
...
with DeepExplain(session = K.get_session()) as de:
    ...
    #Y_test_true = Y_test[np.argwhere(preds == Y_test.argmax(axis=-1))]
    #print(target_tensor.shape, (target_tensor * Y_test).shape, input_tensor.shape, X_test.shape)
    attributions_MM = de.explain('deeplift', target_tensor * Y_test, input_tensor, X_test)
    #attributions = de.explain('deeplift', target_tensor * Y_test_true, input_tensor, X_test_true)
    #attributions = de.explain('elrp', target_tensor * Y_test, input_tensor, X_test)
    #attributions = de.explain('saliency', T, X, xs[i], ys=ys[i], batch_size=3)
    #attributions = de.explain('occlusion', target_tensor * Y_test, input_tensor, X_test)
...
# plot the explain
#print(attributions)
print(attributions_MM.shape)
plt.imshow(attributions_MM[0, :, :].squeeze(),aspect='auto')
plt.colorbar()
x=[0,250,500,750]
values = [i/500 for i in x]
plt.xticks(x,values)
...
# plot the explain
#print(attributions)
diff_attributions_1 = attributions_JG -attributions_MM
plt.imshow(diff_attributions_1[0, :, :].squeeze(),aspect='auto')
plt.colorbar()
x=[0,250,500,750]
values = [i/500 for i in x]
plt.xticks(x,values)
...
X_test       = X[6]     #0 -- 2; 2-- 3 134 132; 6 -- 4
Y_test       = y[6]
...
with DeepExplain(session = K.get_session()) as de:
    ...
    #Y_test_true = Y_test[np.argwhere(preds == Y_test.argmax(axis=-1))]
    #print(target_tensor.shape, (target_tensor * Y_test).shape, input_tensor.shape, X_test.shape)
    attributions_JY = de.explain('deeplift', target_tensor * Y_test, input_tensor, X_test)
    #attributions = de.explain('deeplift', target_tensor * Y_test_true, input_tensor, X_test_true)
    #attributions = de.explain('elrp', target_tensor * Y_test, input_tensor, X_test)
    #attributions = de.explain('saliency', T, X, xs[i], ys=ys[i], batch_size=3)
    #attributions = de.explain('occlusion', target_tensor * Y_test, input_tensor, X_test)
...
# plot the explain
#print(attributions)
print(attributions_JY.shape)
plt.imshow(attributions_JY[0, :, :].squeeze(),aspect='auto')
plt.colorbar()
x=[0,250,500,750]
values = [i/500 for i in x]
plt.xticks(x,values)
...
# plot the explain
#print(attributions)
diff_attributions_2 = attributions_JY -attributions_MM
plt.imshow(diff_attributions_2[0, :, :].squeeze(),aspect='auto')
plt.colorbar()
x=[0,250,500,750]
values = [i/500 for i in x]
plt.xticks(x,values)
